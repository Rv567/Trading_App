...
def app():
    ...
    # Load stock data from session state
    ...
    st.write("We start with calculating the spread (price difference the two stocks), then we normalize it to obtain the z-score.")
    
    # Z-score Calculation
    st.subheader("Z-score Calculating")
