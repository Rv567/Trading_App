...
def app():
    ...
    st.markdown("""
        ### How We Calculate Weekly Percentage Change

        To understand the weekly variation of a stock, we calculate the percentage change in the closing price from one week to the next. Here’s how we do it:
