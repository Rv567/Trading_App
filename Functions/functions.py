...
def modify_df(df):
    ...
    df_rounded.iloc[1] = pd.to_datetime(df_rounded.iloc[1], errors='coerce').dt.date
    df_rounded.iloc[1] = pd.to_datetime(df_rounded.iloc[1], errors='coerce').dt.date
    df_rounded.iloc[18] = pd.to_datetime(df_rounded.iloc[2], errors='coerce').dt.date
    df_rounded.iloc[19] = pd.to_datetime(df_rounded.iloc[1], errors='coerce').dt.date
