...
def app():
    ...
    **Beta measures how much a stock's price moves compared to the overall market. It's basically a risk indicator.**
    ...
    df = df.rename(columns={"name":"Name","close":"Close","beta_1_year":"Beta 1Y","price_earnings_ttm":"P/E","price_book_ratio":"P/B","dividends_yield":"Div Yield %","net_income_yoy_growth_fy":"Net Income Growth","Perf.YTD":"Perf %","volume":"Volume"})
