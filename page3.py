...
def app():
    ...
    metrics_def = ["The total percentage gain or loss on an investment over a specified period.  $$ \\text{Return} = \\left( \\frac{V_f - V_i}{V_i} \\right) \\times 100 $$",
                   "The return if the asset was bought at the start and held until the end of the period, without any trading.  $$ \\text{BuyandHoldReturn} = \\left( \\frac{P_{end} - P_{start}}{P_{start}} \\right) \\times 100 $$",
